...
const PROGRAM_VERSION = 'CTGDPT-2018-2026-V8';
const PASS_SCORE = 8;
...
function makeLesson(grade, subjectId, index) {
  ...
  const theory = [
    `Trong môn ${baseSubjectName} lớp ${grade}, bài này tập trung vào ${topic.toLowerCase()}. Nội dung được thiết kế riêng cho lớp ${grade}, không dùng lại nguyên mẫu của lớp khác.`,
    `Trước tiên hãy quan sát ví dụ, xác định khái niệm hoặc dữ kiện trọng tâm, sau đó trình bày cách hiểu bằng lời của em.`,
    `Yêu cầu cần đạt là ${levelText}. Em nên ghi lại lỗi sai và làm phần vận dụng sau khi nắm chắc kiến thức.`
  ];
  const objectives = [
